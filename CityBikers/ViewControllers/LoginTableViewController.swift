...
class LoginTableViewController: UITableViewController {
    ...
    @IBAction func loginButtonTapped(_ sender: Any) {
        ...
        self.appDelegate.user = User(withUername: "", email: email, password: password, city: "", andCountry: "")
        self.firebaseUserDataService?.loginUser(withEmail: (self.user?.email)!, andPassword: (self.user?.password)!)
